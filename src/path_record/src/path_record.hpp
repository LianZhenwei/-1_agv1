...
private:
  ...
  void odometryGetCallBack_slam2(const nav_msgs::Odometry::ConstPtr odometry_msg);
  void odometryGetCallBack_slam3(const nav_msgs::Odometry::ConstPtr odometry_msg);
  void odometryGetCallBack_slam3_2(const nav_msgs::Odometry::ConstPtr odometry_msg);
